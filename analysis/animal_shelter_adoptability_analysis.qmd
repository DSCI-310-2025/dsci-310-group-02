...
table3 <- read_csv('../results/name3.csv')
```
...
![Animal Type vs Outcome Type](../results/name4.png){width=75% #fig-typetype}

![Animal Type vs Outcome Group (adopted / not adopted)](../results/name5.png){width=75% #fig-typegroup}
...
![Intake Condition vs Outcome Type](../results/name6.png){width=75% #fig-condtype}

![Intake Condition vs Outcome Group (adopted / not adopted)](../results/name7.png){width=75% #fig-condgroup}
