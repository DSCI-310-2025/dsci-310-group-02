...
table1 <- read_csv('../results/name1.csv')
table2 <- read_csv('../results/name2.csv')
table3 <- read_csv('../results/name1.csv')
```
...
![Animal Type vs Outcome Type](../results/name4.png){width=75% #fig-type_type}
![Animal Type vs Outcome Group (adopted / not adopted)](../results/name5.png){width=75% #fig-type_group}

**Explanation of Relevance:** Based on @fig-type_type and @fig-type_group, we can see a high adoptability rate if the
...
![Intake Condition vs Outcome Type](../results/name6.png){width=75% #fig-condition_type}
![Intake Condition vs Outcome Group (adopted / not adopted)](../results/name7.png){width=75% #fig-condition_group}

**Explanation of Relevance:** Based on @fig-condition_type and @fig-condition_group we can see there is a clear
...
![Age at Intake vs Outcome Group (adopted / not adopted)](../results/name8.png){width=75% #fig-age}
...
Using the elbow graph above, we found that the best number of neighbors (k) for our classification is 5. This is the
...
```{r}
#![ROC plot for our model](../results/roc_curve.png){width=75% #fig-roc}
```{r}
```{r}
#| label: tbl-modelsum
...
To visualize our results, we created a roc plot (@fig-roc) to assess our model's performance and some summary statistics
(@tbl-modelsum) to assess our model's accuracy.
